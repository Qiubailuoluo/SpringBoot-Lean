...
## 代码位置
- Controller：`java/com/bookshop/controller/book/BookController.java`
- Service：`java/com/bookshop/service/book/BookService.java`
- ServiceImpl：`java/com/bookshop/service/book/impl/BookServiceImpl.java`
- Mapper：`java/com/bookshop/mapper/book/BookMapper.java`
- DTO/VO：`java/com/bookshop/dto/book`、`java/com/bookshop/vo/book`
...
- `java/com/bookshop/service/book/impl/BookServiceImpl.java`
