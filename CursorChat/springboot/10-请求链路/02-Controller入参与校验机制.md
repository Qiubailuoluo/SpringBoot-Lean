...
## 代码位置
com/bookshop/
- 图书控制器：`controller/book/BookController.java`
- 登录控制器：`controller/login/LoginController.java`
- 用户控制器：`controller/user/UserController.java`
- 示例 DTO：`dto/book/BookUpdateDTO.java`
